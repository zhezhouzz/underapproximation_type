...
(* Lemma st_type_closed_empty_not_ctx_implies_not_free: forall Gamma x tau, *)
(*     st_type_closed_in_ctx empty Gamma tau *)

(*   Hclosed : st_type_closed_in_ctx empty Gamma tau *)
(*   Hex : Gamma \C- e_x \Tin tau_x *)
(*   HexD : tmR_in_ctx_all_st Gamma tau_x e_x *)
(*   He : (Gamma <l> x :l: tau_x) \C- e \Tin tau *)
(*   HeD : tmR_in_ctx_all_st (Gamma <l> x :l: tau_x) tau e *)
(*   H : ctx_inv empty (Gamma <l> x :l: tau_x) *)
(*   H0 : l_find_right_most Gamma x = None *)
(*   ============================ *)
...
Proof with eauto.
  ...
  - intros e tau1 tau2 (Hinv & Hclosed) He HeD Hsub.
    ...
    eapply denotation_is_closed in H0...
  ...
  - intros x e_x e tau tau_x (Hinv & Hclosed) Hex HexD He HeD.
    ...
    eapply st_type_closed_in_ctx_emp_implies_all_not_free...
  (* letop *)
