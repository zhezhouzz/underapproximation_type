...
Proof with eauto.
  ...
  - constructor... inversion He_xD; subst. inversion HeD; subst.
    ...
    + assert (tmR_in_ctx_aux st [] tau (tlete x e_x e)) as HD... inversion HD; subst...
  - destruct a as (a & tau_a). assert (type_ctx_no_dup ((a, tau_a) :: Gamma ++ ((x, Uty tau_x)::nil))) as Hnodup...
    inversion HeD; subst.
    + constructor...
      intros c_x Hc_xD.
    ...
    + constructor...
      ...
      assert (tmR_in_ctx_aux (a |-> e_x_hat3; st) Gamma tau (tlete x (tlete a e_x' e_x) (tlete a e_x' e)))...
      eapply IHGamma with (tau_x:= tau_x)... admit.
      eapply step_preserve_ctx_denotation... eapply eta_lete_neq...
    + constructor...
      inversion He_xD; subst.
      intros e_x' He_xD'.
