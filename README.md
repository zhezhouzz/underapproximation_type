...
### Building Cobalt from Source (Optional):
We have successfully tried building Cobalt[https://github.com/aegis-iisc/propsynth.git] on Linux (Ubuntu 16.04) and Mac(macOs Monterey). We discuss the instructions for the Ubuntu build and running.
